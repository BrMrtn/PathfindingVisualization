...
public class BestFirstSearch extends Algorithm {
    ...
    public BestFirstSearch(GUI g, Color c, int d){
        super(g, c, d);
        ...
        while (!queue.isEmpty()) {
            Collections.sort(queue, new Comparator<Node>() {
                ...
                public int compare(Node o1, Node o2) {
                    return Double.compare(getDistance(o1, destination), getDistance(o2, destination));
                }
            });
    ...
    public Algorithm resetObject() {
        return new BestFirstSearch(GUI, color, delay);
    }
